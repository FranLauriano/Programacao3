	...
	$('.toggle-collapsed').each(function(){
		if($(this).hasClass('on-hover')){
			...
			$(this).parent().hover(function(){
				...
				$(this).find('img').attr("src", '/siab/libs/img/toggle-subnav-up-white.png');
			}, function(){
				$(this).removeClass("open");
				$(this).find('.collapsed-nav').slideUp();
				$(this).find('img').attr("src", '/siab/libs/img/toggle-subnav-down.png');
			});
		} else {
